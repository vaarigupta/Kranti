    ...
    return(
      ...
      <div className="row ">
              ...
              <span class="card-title activator grey-text text-darken-4"> Ashwini<i class="material-icons right">tap</i></span>
                ...
                <div class="card-reveal">
                  <span class="card-title grey-text text-darken-4">Card Title<i class="material-icons right">close</i></span>
                  <p>Hello everyone!! I'm Ashwini. It's been 2 years in Kranti and that was the most wonderful years of my life. Right now I'm in New York studying in college of New Rochelle. It’s been just two months in New York. The start was very difficult for me, but now I'm ok! To reach till this point it was all possible because of all the people who supported me without even knowing me. I want to be an art therapist not only because I love art, but art helps me to  express myself. I want to reach out to people through art because there are many people like me who can't express themselves through words. I have seen many nice and wonderful people in my life and they have given me a lot and I want to give to the world what I have got.</p>
                </div>
              </div>
      ...
      <div className="row"> 
          ...
          <div class="card col m4 l4 s12 amber lighten-2">

            <div class="card-content">
              <span class="card-title activator grey-text text-darken-4"> Danish<i class="material-icons right">tap</i></span>

            </div>
            <div class="card-reveal">
              <span class="card-title grey-text text-darken-4">Card Title<i class="material-icons right">close</i></span>
              <p> Hi my name is Danish! I just started my university at the University of the West in LA. Since I was at Kranti I got to know more about therapy, and I took therapy for past 3 years. This has really shaped my life so much, because while growing up I carried lots of my negative past experiences with me, but after therapy it helped me to remind myself this doesn’t serve me and I have to do my best to let it go and focus on something more positive. Being able to understand about therapy at such young age I found myself end up studying psychology. Studying abroad for my bachelor’s degree is challenging but I am also grateful for the people  and Kranti who have helping me to have such beneficial education experience in the USA.</p>
            </div>
          </div>


          <div class="card col m4 l4 s12 pink lighten-4">

            <div class="card-content">
              <span class="card-title activator grey-text text-darken-4"> Farah<i class="material-icons right">tap</i></span>

            </div>
            <div class="card-reveal">
              <span class="card-title grey-text text-darken-4">Card Title<i class="material-icons right">close</i></span>
              <p>  Hello, My name is Farah Shaikh. I am 23 years old, when I was in India I completed my DED (Diploma in teacher education). After completing that I started working with many schools in Mumbai. I have also worked with TFI (Teach for india) and also with special children. In the beginning my dream was to become a journalist but I ended up becoming a teacher and it's funny ;) .  After working with different school I decided that I want to be a child therapist and I wanted to study psychology with mindfulness. So now I am in USA and I am studying in University of the West! It's a Buddhist college and I am completing my undergraduate in Psychology program. It's nice to be in different county and learning new things, I really love my university and I think I am learning every day. Currently my dream is to become a child psychologist and hope to achieve my dream.</p>
            </div>
          </div>


          <div class="card col m4 l4 s12 cyan lighten-3">

            <div class="card-content">
              <span class="card-title activator grey-text text-darken-4"> Kavita <i class="material-icons right">tap</i></span>

            </div>
            <div class="card-reveal">
              <span class="card-title grey-text text-darken-4">Card Title<i class="material-icons right">close</i></span>
              <p> Hello Everyone, My name is Kavita, I am 23 years old. My favourite person in this world is my Dadi (grandmother). She has given me her whole life to be a better person. My best friends are so many because I feel every individual is best in their own way. I have been at Kranti for almost 4 beautiful years. These years have brought lot of growth and learnings to me, different types of life skills, confidence, learned the meaning of success, got a beautiful Kranti family and explored the world and got a whole different perspective of life from different experiences. I have a few hobbies which include talking to my friends, drawing, singing and now there is one more I have discovered, a new one is to listen to people, and I swear it has changed my life :). Right now I am in Bangalore with Sheetal, soon we are going to intern at M.A.D. non-profit organisation  (Make A Difference) for 6 months. We are very excited and pretty nervous at the same time, because both of us had worked but in different sectors and this is going to be different. It's a very big opportunity for us to learn and develop different types of skills which will help us in future to work. </p>
            </div>
          </div>
        ...
        <div className="row">  
                  ...
                  <div class="card col m4 l4 s12 purple lighten-3">

                    <div class="card-content">
                      <span class="card-title activator grey-text text-darken-4"> Pinky <i class="material-icons right">tap</i></span>

                    </div>
                    <div class="card-reveal">
                      <span class="card-title grey-text text-darken-4">Card Title<i class="material-icons right">close</i></span>
                      <p>
                        My name is Pinky Sheikh and I am 20 years old. I was the first girl to come to Kranti! When I leave Kranti, I want to become a teacher or an animal therapist because I LOVE animals. I have many hobbies, but my favourite things are singing, swimming, and dancing. Four years ago, I went to America for a dance camp for one month and I discover that I love travel. Now, I want to go to Africa because I think African people are very beautiful. I like being at Kranti because here I get therapy and that has change my life. This is why I want to be a therapist. Last, I would like to say I am from Kolkata and my mother is a sex worker. Her whole life she is fighting many problems, and I am very proud of my mother. </p>
                    </div>
                  </div>


                <div class="card col m4 l4 s12 cyan lighten-4">

                  <div class="card-content">
                    <span class="card-title activator grey-text text-darken-4">Mahek <i class="material-icons right">tap</i></span>

                  </div>
                  <div class="card-reveal">
                    <span class="card-title grey-text text-darken-4">Card Title<i class="material-icons right">close</i></span>
                    <p>  Hi I am Mahek. I am 14 years old. I came to Kranti in 2014 on 5 April which is my birthday. I am not living in Kranti home right now because I am at boarding school in Mussoorie! I like to read story books, and I likes chocolate ice cream chips etc. I am having sooo much fun in Kranti. And in Kranti I got 12 sisters and I thank a lot to Kranti and Kranti's girls.  </p>
                  </div>
                </div>

              <div class="card col m4 l4 s12 teal lighten-3">

                    <div class="card-content">
                      <span class="card-title activator grey-text text-darken-4"> Rani <i class="material-icons right">tap</i></span>

                    </div>
                    <div class="card-reveal">
                      <span class="card-title grey-text text-darken-4">Card Title<i class="material-icons right">close</i></span>
                      <p>   Hi! My name is Jayashree but my dad used to call me Rani which means queen, so most of the people who know me very well they also call me Rani. Right now I'm seventeen and I have lots of problems in my life for example so many people make me to think about my future.
      ...
      <div className="row">
          <div class="card col m4 l4 s12 yellow lighten-2">

            <div class="card-content">
              <span class="card-title activator grey-text text-darken-4"> Shweta <i class="material-icons right">tap</i></span>
          ...
          <div class="card col m4 l4 s12 red lighten-3">

            <div class="card-content">
              <span class="card-title activator grey-text text-darken-4">Taniya<i class="material-icons right">tap</i></span>

            </div>
            <div class="card-reveal">
              <span class="card-title grey-text text-darken-4">Card Title<i class="material-icons right">close</i></span>
              <p>    People call me Taniya!! But I call myself beautiful. That’s who I am. Hello everyone, I was born in Kolkata. I don't know who was my father but I'm really curious to see him once. Right now 
